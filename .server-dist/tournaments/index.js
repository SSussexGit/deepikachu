"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _generatorelimination = require('./generator-elimination');
...
const chatCommands = {
	...
	tournament(target, room, user, connection) {
		...
		if (cmd === '') {
			...
			const tournament = (room.game && room.game.gameid === 'tournament') ? room.game  : null;
			if (!tournament) {
